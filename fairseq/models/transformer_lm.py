...
@register_model_architecture('transformer_lm', 'transformer_lm_wiki103_emb_big')
@register_model_architecture('transformer_lm', 'transformer_lm_baevski_wiki103_emb_big')
def transformer_lm_baevski_wiki103(args):
    args.decoder_layers = getattr(args, 'decoder_layers', 16)
    args.decoder_attention_heads = getattr(args, 'decoder_attention_heads', 16)
...
@register_model_architecture('transformer_lm', 'transformer_lm_wiki103_ffn_big')
@register_model_architecture('transformer_lm', 'transformer_lm_baevski_wiki103_ffn_big')
def transformer_lm_baevski_wiki103(args):
    args.decoder_layers = getattr(args, 'decoder_layers', 16)
    args.decoder_attention_heads = getattr(args, 'decoder_attention_heads', 16)
    args.decoder_embed_dim = getattr(args, 'decoder_embed_dim', 1024)
...
@register_model_architecture('transformer_lm', 'transformer_lm_wiki103_16_16')
@register_model_architecture('transformer_lm', 'transformer_lm_baevski_wiki103_16_16')
def transformer_lm_baevski_wiki103(args):
    args.decoder_layers = getattr(args, 'decoder_layers', 16)
    args.decoder_attention_heads = getattr(args, 'decoder_attention_heads', 16)
    args.dropout = getattr(args, 'dropout', 0.3)
...
@register_model_architecture('transformer_lm', 'transformer_lm_wiki103_18_8')
@register_model_architecture('transformer_lm', 'transformer_lm_baevski_wiki103_18_8')
def transformer_lm_baevski_wiki103(args):
...
@register_model_architecture('transformer_lm', 'transformer_lm_wiki103_16_8')
@register_model_architecture('transformer_lm', 'transformer_lm_baevski_wiki103_16_8')
def transformer_lm_baevski_wiki103(args):
    args.decoder_layers = getattr(args, 'decoder_layers', 16)
    args.decoder_attention_heads = getattr(args, 'decoder_attention_heads', 8)
    args.dropout = getattr(args, 'dropout', 0.3)
...
@register_model_architecture('transformer_lm', 'transformer_lm_wiki103_12_8')
@register_model_architecture('transformer_lm', 'transformer_lm_baevski_wiki103_12_8')
def transformer_lm_baevski_wiki103(args):
    args.decoder_layers = getattr(args, 'decoder_layers', 12)
    args.decoder_attention_heads = getattr(args, 'decoder_attention_heads', 8)
    args.dropout = getattr(args, 'dropout', 0.3)
...
@register_model_architecture('transformer_lm', 'transformer_lm_wiki103_8_4')
@register_model_architecture('transformer_lm', 'transformer_lm_baevski_wiki103_8_4')
def transformer_lm_baevski_wiki103(args):
...
@register_model_architecture('transformer_lm', 'transformer_lm_wiki103_8_8')
@register_model_architecture('transformer_lm', 'transformer_lm_baevski_wiki103_8_8')
def transformer_lm_baevski_wiki103(args):
    args.decoder_layers = getattr(args, 'decoder_layers', 8)
    args.decoder_attention_heads = getattr(args, 'decoder_attention_heads', 8)
    args.dropout = getattr(args, 'dropout', 0.3)
...
@register_model_architecture('transformer_lm', 'transformer_lm_wiki103_4_4')
@register_model_architecture('transformer_lm', 'transformer_lm_baevski_wiki103_4_4')
def transformer_lm_baevski_wiki103(args):
...
@register_model_architecture('transformer_lm', 'transformer_lm_wiki103_16_8_ffn_big')
@register_model_architecture('transformer_lm', 'transformer_lm_baevski_wiki103_16_8_ffn_big')
def transformer_lm_baevski_wiki103(args):
    args.decoder_layers = getattr(args, 'decoder_layers', 16)
    args.decoder_attention_heads = getattr(args, 'decoder_attention_heads', 8)
    args.decoder_embed_dim = getattr(args, 'decoder_embed_dim', 1024)
...
@register_model_architecture('transformer_lm', 'transformer_lm_wiki103_8_8_ffn_big')
@register_model_architecture('transformer_lm', 'transformer_lm_baevski_wiki103_8_8_ffn_big')
def transformer_lm_baevski_wiki103(args):
    args.decoder_layers = getattr(args, 'decoder_layers', 8)
    args.decoder_attention_heads = getattr(args, 'decoder_attention_heads', 8)
    args.decoder_embed_dim = getattr(args, 'decoder_embed_dim', 1024)
